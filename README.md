...
## Environments
- Preview: https://main--aem-eds-cloud-authoring--parvathisomanahallicnx.aem.page/
- Live: https://main--aem-eds-cloud-authoring--parvathisomanahallicnx.aem.live/
...
1. Open the `aem-eds-cloud-authoring` directory in your favorite IDE and start coding :)
